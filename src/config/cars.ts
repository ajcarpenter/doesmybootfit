...
export const PRESET_CARS: Record<string, CarConfig> = {
  ...
  GOLF_8_SW: { name: 'Volkswagen Golf 8 SW (estate)', W: 101, D: 104, H_shelf_in: 49, H_shelf_out: 68 },
  PEUGEOT_308_SW: { name: 'Peugeot 308 SW (estate)', W: 104, D: 103, H_shelf_in: 49, H_shelf_out: 68 },
  ...
  PASSAT_SW: { name: 'Volkswagen Passat SW (estate)', W: 100, D: 114, H_shelf_in: 50, H_shelf_out: 76 },
  ...
  MEGANE_ESTATE: { name: 'Renault Mégane Estate (IV)', W: 110, D: 93, H_shelf_in: 46, H_shelf_out: 68 },
  ...
  MEGANE_ESTATE_VS_308_SW_REF: { name: 'Peugeot 308 SW (II as ref. set)', W: 106, D: 107, H_shelf_in: 50, H_shelf_out: 72 }
};
