...
const DraggableBox: React.FC<DraggableBoxProps> = ({ obj, dims, isActive, showGizmo, onDrag, onPointerDown, onPointerUp, allowDrag = true, onRotate, onRotateStart, onRotateEnd }) => {
  ...
  onPointerOver={() => { /* highlight handled elsewhere if needed */ }}
  onPointerOut={() => { /* noop */ }}
        onPointerDown={e => {
          e.stopPropagation();
